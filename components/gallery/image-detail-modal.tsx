...
interface ImageDetailModalProps {
  ...
  onEdit: (image: GeneratedMedia) => void;
  onReport: (id: string) => void;
  onDownload: (image: GeneratedMedia) => void;
}

export function ImageDetailModal({ image, onClose, onApprove, onEdit, onReport, onDownload }: ImageDetailModalProps) {
        ...
        >
          ...
          <div className="relative w-full md:w-1/2 aspect-square bg-black shrink-0">
            <ProtectedImage
              ...
              watermarkText="PENDIENTE DE APROBACIÓN"
            />
          </div>
            ...
            <div className="flex-1 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="rounded-lg bg-secondary p-3">
                  ...
                  <p className="text-base font-medium text-foreground">{image.edit_count}</p>
                </div>
              ...
              {!image.is_approved ? (
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-3 grid grid-cols-3 gap-2">
                        ...
                        <Button variant="secondary" size="sm" onClick={() => { onClose(); onEdit(image); }}>
                ...
                <>
                  ...
                  <div className="flex gap-3">
                    <Button variant="secondary" className="flex-1" onClick={() => { onClose(); onEdit(image); }}>
