...
export function ReportModal({ isOpen, onClose, mediaId }: ReportModalProps) {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Errores manejados por el store
    } finally {
          ...
          >
            {success ? (
              <div className="text-center">
                ...
                <p className="mt-2 text-muted-foreground">Revisaremos tu reporte lo antes posible.</p>
              </div>
            ) : (
              <>
                ...
                <textarea
                  ...
                  placeholder="Ej: Errores visuales, no sigue el prompt..."
                ...
                <div className="mt-4 flex gap-2">
                  ...
                  <Button variant="destructive" className="flex-1" onClick={handleSubmit} disabled={!reportReason.trim() || isSubmitting} isLoading={isSubmitting}>
                    Enviar
                  </Button>
                </div>
              </>
